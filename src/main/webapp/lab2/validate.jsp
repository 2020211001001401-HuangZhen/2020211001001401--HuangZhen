...
--%>
<%@ page import="com.HuangZhen.lab2.Login" %>
...
<jsp:useBean id="Login" class="com.HuangZhen.lab2.Login" scope="request"></jsp:useBean>
...
<%
    ...
    System.out.print("username or password error message");
%>
