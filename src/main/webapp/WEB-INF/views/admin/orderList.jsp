			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.HuangZhen.model.Order o=(com.HuangZhen.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.HuangZhen.dao.UserDao userDao=new com.HuangZhen.dao.UserDao();
						...
						<%
							...
							String paymentType=com.HuangZhen.model.Payment.findByPaymentId(con,n);
							 %>
