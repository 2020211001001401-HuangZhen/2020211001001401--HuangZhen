		...
		<div class="table-responsive col-sm-10">
			...
			<c:forEach var="p" items="${productList}" varStatus="vs">
				<tr>
					...
					<%
						com.HuangZhen.model.Product p= (com.HuangZhen.model.Product) pageContext.findAttribute("p");
						int pid=p.getCategoryId();
						java.sql.Connection con= (java.sql.Connection) application.getAttribute("con");
						String catName=com.HuangZhen.model.Category.findByCategoryId(con,pid);
					%>
